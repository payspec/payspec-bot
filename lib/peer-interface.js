...
module.exports =  {
 ...
 /*
  ...
  async initJSONRPCServer()
     ...
     {
       var obj = await self.mongoInterface.findOne('merchantServerInvoicePaidCallbackURL'  )
       return obj.value;
     },
     ...
     {
        console.log('sha 3 inputs ', web3utils.toChecksumAddress(newInvoiceData.msgSenderAddress), newInvoiceData.refNumber, newInvoiceData.description, web3utils.toChecksumAddress(newInvoiceData.tokenAddress), newInvoiceData.amountDue, web3utils.toChecksumAddress(newInvoiceData.recipientAddress))

       var digest = web3utils.soliditySha3({t: 'address', v: web3utils.toChecksumAddress(newInvoiceData.msgSenderAddress)}, {t: 'uint256', v: newInvoiceData.refNumber }, {t: 'string', v: newInvoiceData.description }, {t: 'address', v: web3utils.toChecksumAddress(newInvoiceData.tokenAddress) }, {t: 'uint256', v: newInvoiceData.amountDue }, {t: 'address', v: web3utils.toChecksumAddress(newInvoiceData.recipientAddress) });
