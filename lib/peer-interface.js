...
module.exports =  {
  ...
  async init(   mongoInterface, web3 )
  {
  ...
  */
  async pollEthereumNetwork()
  {
    ...
    await self.mongoInterface.insertOne('ethBlockNumber',  {value: ethBlockNumber  } )

    console.log('got eth block',  ethBlockNumber )
    var expirationBlocks = 1000;// 4 hours
 ...
 /*
  ...
  async initJSONRPCServer()
         ...
         var server = jayson.server({
           ...
           generateOffchainInvoice: async function(args, callback) {
            ...
            /* payspecData = {
             ...
             var ethBlockNumber = await getEthBlockNumber()
             ...
             invoiceInputs = {
               ...
               ethBlockExpiresAt: 0  //consider making this non zero, get eth block
             }
     ...
     {
       var obj = await self.mongoInterface.findOne('ethBlockNumber'  )
       return obj.value;
     },
