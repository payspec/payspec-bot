...
module.exports =  {
  ...
  //  this.webInterface=webInterface;
     this.peerInterface=peerInterface;
      ...
      app.get('/invoice_data/:uuid', async function(req,res)
            {
              var uuid = req.params.uuid;
              //console.log(req.params.uuid)

              var invoice = await self.peerInterface.findInvoiceWithUUID(uuid)
    ...
    //  app.get('/', (req, res) => res.send('Hello World!'))
      ...
      app.listen(3050, () => console.log('Web app listening on port 3050!'))
